...
from ui.registr_eq_admin import RegistrationWindowA
...
class MainWindowA(QMainWindow):
    ...
    def open_register_equipment_window(self):
        self.eq_window = RegistrationWindowA(parent=self)
    ...
    def show_main_page(self):
        ...
        #self.show()
        main_widget = MainWindowA()  # Замени на реальный главный виджет
